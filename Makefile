...
app: $(APP_NAME)-native ## Create a in-your-eyes.app
app-universal: $(APP_NAME)-universal ## Create a universal in-your-eyes.app
$(APP_NAME)-%: $(TARGET)-%
...
dmg: $(DMG_NAME)-native ## Create a in-your-eyes.dmg
dmg-universal: $(DMG_NAME)-universal ## Create a universal in-your-eyes.dmg
$(DMG_NAME)-%: $(APP_NAME)-%
