...
pub fn colorramp_fill_float(
    ...
    let step = color.brightness / (ramp_size - 1) as f64;
    for i in 0..ramp_size {
        let v = step * i as f64;
        if !color.inverted {
            r[i] = (v * white_r) as f32;
            g[i] = (v * white_g) as f32;
            b[i] = (v * white_b) as f32;
        } else {
            // r[i] = u16::MAX - (v * white_r) as f32;
            // g[i] = u16::MAX - (v * white_g) as f32;
            // b[i] = u16::MAX - (v * white_b) as f32;
        }
    }
}
